...
-- Acesso livre para todos os perfis, já que a autenticação é customizada na tabela app_users
ALTER TABLE public.machine_current_states DISABLE ROW LEVEL SECURITY;
