        ...
        const loadData = async () => {
            try {
                const [
                    ...
                    fetchTable<TransferRecord>('transfers').catch(() => []),
                    fetchTable<ProductionOrderData>('production_orders').catch(() => []),
                    fetchTable<FinishedProductItem>('finished_goods').catch(() => []),
                    fetchTable<PontaItem>('pontas_stock').catch(() => []),
                    fetchTable<FinishedGoodsTransferRecord>('finished_goods_transfers').catch(() => []),
                    fetchTable<PartsRequest>('parts_requests').catch(() => []),
                    fetchTable<ShiftReport>('shift_reports').catch(() => []),
                    fetchTable<ProductionRecord>('production_records').catch(() => []),
