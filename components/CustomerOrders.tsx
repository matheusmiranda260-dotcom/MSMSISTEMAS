                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-slate-800 text-white">
                                <th className="p-4 text-center font-bold text-xs uppercase w-20 border-r border-slate-700">Nº</th>
                                <th className="p-4 text-center font-bold text-xs uppercase w-24 border-r border-slate-700">Data</th>
                                <th className="p-4 text-center font-bold text-xs uppercase w-28 border-r border-slate-700">Vendedor</th>
                                <th className="p-4 font-bold text-xs uppercase min-w-[250px] max-w-[350px] border-r border-slate-700">Cliente</th>
                                <th className="p-4 text-center font-bold text-xs uppercase w-32 border-r border-slate-700">Leitura</th>
                                <th className="w-full border-r border-slate-700"></th>
                                <th className="p-4 text-center font-bold text-xs uppercase w-32 border-r border-slate-700">Status</th>
                                <th className="p-4 text-center font-bold text-xs uppercase w-36 border-r border-slate-700">Preço</th>
